...
// The main concept of merge sort is that an array of length 1 is sorted. 
// 1. Split the array elements into individual elements.
// 2. Compare the individual elements and arrange them in order. 
//    This results in subarrays of length 1 or 2.
// 3. Make an empty array.
// 4. Compare the elements of the subarrays and push the smaller of the values to the empty array.
// 5. If you had extracted all the values from one of the arrays, 
//    push the remaining array to the new array.
// 6. Continue until all subarrays have been covered and you have one sorted array.
